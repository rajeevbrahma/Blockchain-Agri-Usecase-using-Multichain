        ...
        try:
                ...
                if message["messagetype"] == "req":
                        ...
                        if message["messagecode"] == "createexchange":
                                RS.issueRSasset()
                        if message["messagecode"] == "createexchange":
                                RS.createExchange(message["ownasset"],message["otherasset"])
...
if __name__ == '__main__':
        ...
        rpcport = '6296'
        chainname = 'chain1'
        RS = Warehouse(rpcuser,rpcpasswd,rpchost,rpcport,chainname)
        print RS.connectTochain()
        print RS.warehouseAddress()
